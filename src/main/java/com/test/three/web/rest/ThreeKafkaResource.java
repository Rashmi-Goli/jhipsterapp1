...
@RestController
@RequestMapping("/api/three-kafka")
public class ThreeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ThreeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ThreeKafkaResource(KafkaProperties kafkaProperties) {
